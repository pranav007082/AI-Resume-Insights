      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            Cut Through the Noise – Real Feedback, Real Improvement.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              Receive a comprehensive score out of 10 for your resume, evaluating
               critical aspects such as brevity, style, and impact. Get instant insights 
               into where you shine and where you can improve.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Unlock actionable, targeted feedback tailored to your resume’s 
              specific shortcomings. Our system provides clear recommendations to 
              enhance your content and presentation, boosting your chances of landing 
              interviews.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              Easily track your resume's evolution by storing previous versions. 
              Monitor your improvements over time to see how your changes positively
               impact your resume's quality and effectiveness.
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              Effortlessly generate compelling cover letters with our AI-driven writing tool.
               Customize your cover letters to match your resume and highlight your strengths 
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              Get a detailed line-by-line analysis of your resume,
               including spell checks and formatting recommendations. 
               Ensure your resume is polished and professional before submitting 
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              Test your knowledge with quizzes based on the skills listed 
              in your resume. Validate your expertise and prepare for interviews with
               confidence as you reinforce your knowledge.
              </p>
            </article>
          </div>
        </div>
